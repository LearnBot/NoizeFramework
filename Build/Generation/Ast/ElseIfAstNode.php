...
/**
 * A elseif node of the PHP abstract syntax tree.
 *
 * @final
 * @author Jan Gräfen
 * @package Build
 ...
 * @version 1.0
 */
final class ElseIfAstNode extends BaseAstNode {
    
    /**
     * Stores the condition of the current if node.
     *
     * @var string
     */
    private $condition = '';
