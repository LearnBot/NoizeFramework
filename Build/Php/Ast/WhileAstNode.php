...
/**
 * A while node of the PHP abstract syntax tree.
 *
 * @final
 * @author Jan Gräfen
 * @package Build
 ...
 * @version 1.0
 */
final class WhileAstNode extends BaseAstNode {
    
    /**
     * Stores the condition of the current while node.
     *
     * @var string
     */
    private $condition = '';
